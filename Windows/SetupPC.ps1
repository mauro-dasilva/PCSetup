...
wsl.exe bash -c "curl -s https://ohmyposh.dev/install.sh | sudo bash -s -- -t ~/.cache/oh-my-posh/themes"
...
wsl.exe -e bash -c 'echo "export PATH=\$PATH:~/.local/bin" | sudo tee -a ~/.bash_profile'
